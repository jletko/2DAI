...
set UNITY_PROJECT_DIR_PATH=D:\Documents\_git\2DAI
set TRAINING_DIR_PATH=%UNITY_PROJECT_DIR_PATH%\Training
set BRAINS_DIR_PATH=%UNITY_PROJECT_DIR_PATH%\Assets\Brains
